...
- [vite-convert-images](https://github.com/feat-agency/vite-convert-images) - A Vite plugin that automatically converts your raster images into modern formats and responsive variants — with zero hassle.
